  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="mt-8 text-4xl font-black tracking-tight" style={{ color: "#fff" }}>Mot de passe oublié</h1>
        ...
        <div className="mt-6 text-center">
          <a href="/login" className="text-sm transition-colors hover:opacity-70" style={{ color: "rgba(255,255,255,0.5)" }}>
